      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="https://x.com/Dhui228642Dhui?s=09" target="_blank" className="text-base text-gray-500 hover:text-gray-900">
                  X.COM
                </a>
              </li>
              <li>
                <a href="https://okjk.co/OfML1a" target="_blank" className="text-base text-gray-500 hover:text-gray-900">
                  即刻
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} RuoXiao. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
